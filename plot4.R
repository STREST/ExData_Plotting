...
#plot4
png(filename="~/Coursera/week9/r/plot4.png", width = 480, height = 480)
par(mfrow=c(2, 2))
plot(data_s$date,data_s$globalactivepower,type="l",xlab="",ylab="Global Active Power")
plot(data_s$date,data_s$voltage,type="l",xlab="datetime",ylab="Voltage")
...
plot(data_s$date,data_s$globalreactivepower,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()
